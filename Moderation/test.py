def write_words_to_file(word_list, filename):
    # Entferne Anführungszeichen aus jedem Wort und filtere leere Einträge
    cleaned_words = [word.replace('"', '').strip() for word in word_list if word]
    
    # Schreibe die bereinigten Wörter in die Textdatei
    with open(filename, 'w', encoding='utf-8') as file:
        for word in cleaned_words:
            file.write(word + '\n')

# Beispieltext mit verschiedenen Inhalten in Anführungszeichen
words = ["аборт",
        "анальны",
        "анус",
        "задніца",
...
print(f"Wörter wurden in die Datei '{output_filename}' geschrieben.")